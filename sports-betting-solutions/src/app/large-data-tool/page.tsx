...
export default function LargeDataToolPage() {
  ...
  useEffect(() => {
    const fetchDropdownOptions = async () => {
      try {
        console.log('Fetching dropdown options for ALL users');

        // Fetch ALL bets to populate dropdown options (no user filter)
        ...
        console.log('Fetched racing bets:', racingBets?.length || 0, 'records from all users');

        if (!racingBets || racingBets.length === 0) {
          console.log('No racing bets found in database');
          return;
        }
        ...
        console.log('Dropdown options created from all users:', {
  ...
  const handleSearch = async () => {
    try {
      ...
      // MODIFIED: Remove user filter to search ALL users' bets
      let query = supabase
        .from('racing_bets')
        .select('*');
      ...
      console.log('Found bets from ALL users before filtering:', bets?.length || 0);
      ...
      console.log('Found bets from ALL users after filtering:', filteredBets.length);
      ...
      <div className="min-h-screen bg-betting-dark text-white p-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-betting-green mb-2">Large Data Tool</h1>
              <p className="text-gray-400">Search and analyze betting data from all users</p>
            </div>
            <Database className="w-8 h-8 text-betting-green" />
          </div>
          ...
          {showSearchForm ? (
            <div className="bg-betting-dark border border-betting-green/20 rounded-lg p-6 mb-6">
              <h2 className="text-xl font-semibold mb-4 flex items-center">
                ...
                Search All Betting Data
              </h2>
              
              <p className="text-gray-400 text-sm mb-6">
                Sections left empty will include all bets from all users
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* All filter sections with MultiSelect components */}
                <div className="space-y-4">
              ...
              <div className="flex gap-4 mt-6">
                ...
                >
                  ...
                  {searchLoading ? 'Searching...' : 'Search All Data'}
                </button>
            ...
            <div className="space-y-6">
              ...
              {stats && (
                <div className="bg-betting-dark border border-betting-green/20 rounded-lg p-6">
                  <h3 className="text-xl font-semibold mb-4">Search Results (All Users)</h3>
              ...
              {/* BSP Stats */}
              {bspStats && bspStats.numberOfBets > 0 && (
                <div className="bg-betting-dark border border-betting-green/20 rounded-lg p-6">
                  <h3 className="text-xl font-semibold mb-4">Results to BSP (All Users)</h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    <div className="text-center">
              ...
              {/* Best Odds Stats */}
              {bestOddsStats && bestOddsStats.numberOfBets > 0 && (
                <div className="bg-betting-dark border border-betting-green/20 rounded-lg p-6">
                  <h3 className="text-xl font-semibold mb-4">Results to Best Odds (All Users)</h3>
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                    <div className="text-center">
              ...
              {filteredBets.length > 0 && (
                <div className="bg-betting-dark border border-betting-green/20 rounded-lg p-6">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-semibold">Bet by Bet Analysis (All Users)</h3>
                      ...
                      <Line 
                        ...
                        options={{
                          ...
                          plugins: {
                            title: {
                              display: true,
                              text: chartType === 'profitLoss' ? 'Cumulative Profit/Loss (All Users)' : 'Cumulative CLV (All Users)',
                              color: '#ffffff'
                            },
                            legend: {
                              labels: {
